...
[ ! -d /mnt/wsl/wsl_shared ] && wsl.exe --mount C:\\Eliasdns\\Storages\\wsl_shared.vhdx --vhd --partition 1 --type btrfs --options 'noatime,discard=async,ssd' --name wsl_shared > /dev/null
