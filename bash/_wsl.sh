...
[ ! -d /mnt/wsl/wsl_shared ] && wsl.exe --mount C:\\Eliasdns\\Storages\\WSL\\wsl_shared.vhdx --vhd --partition 1 --type btrfs --options 'noatime,ssd,sync' --name wsl_shared > /dev/null
